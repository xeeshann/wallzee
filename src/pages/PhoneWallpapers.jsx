...
const getImagePreviewUrl = (imageId) => {
  if (!imageId) return "https://placehold.co/400x600?text=No+Image";
  
  try {
    // For phone wallpapers, use a taller aspect ratio
    return storage.getFilePreview(
      config.storageId,
      imageId,
      720, // width for mobile screens
      1280, // height - taller aspect ratio
      'center', // gravity
      100 // quality
    ).toString();
  } catch (error) {
    console.error("Error generating image URL:", error);
    return "https://placehold.co/400x600?text=Error";
  }
};

const PhoneWallpapers = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch all wallpapers with 'phone' category
        const phoneWallpapers = await wallpaperService.getWallpapersByCategory('phone');
        console.log("Fetched phone wallpapers:", phoneWallpapers);
        
        if (phoneWallpapers && Array.isArray(phoneWallpapers)) {
          // Sort wallpapers in descending order (latest first) - though this should already be done by the API
          const sortedWallpapers = [...phoneWallpapers].sort((a, b) => 
  ...
  const handleWallpaperClick = (wallpaper) => {
    ...
    document.getElementById('wallpaper_preview_modal').showModal();
  };
  ...
  return (
    <div className="min-h-screen bg-base-100/50 pb-12">
      <SEO 
        title="HD Phone Wallpapers & Backgrounds"
        description="Download beautiful high-quality phone wallpapers and backgrounds. Free HD and 4K mobile wallpapers for iPhone, Android and all smartphones."
        canonicalUrl="https://wallzee.live/phone-wallpapers"
        keywords={[
          'phone wallpapers', 'mobile backgrounds', 'smartphone wallpapers', 
          'iPhone wallpapers', 'Android wallpapers', 'HD mobile wallpapers',
          '4K phone wallpapers', 'free phone backgrounds'
        ]}
        ogImage="https://wallzee.live/images/og-phone-wallpapers.jpg"
      />
      
      {/* Hero Section */}
      <div className="hero py-16 md:py-24 bg-gradient-to-r from-primary/20 to-secondary/20">
        <div className="hero-content text-center">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Free Phone Wallpapers</h1>
            <p className="text-lg mb-8 opacity-80">
              Elevate your mobile experience with our handcrafted collection of high-quality premium phone wallpapers
            </p>
              ...
              <>
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-6">
                  {paginatedWallpapers.map((wallpaper) => (
                    ...
                    >
                    <figure className="relative aspect-[9/16] w-full overflow-hidden">
                      <img 
      ...
      <dialog id="wallpaper_preview_modal" className="modal modal-bottom sm:modal-middle">
        {selectedWallpaper && (
          <div className="modal-box">
            <div className="flex flex-col sm:flex-row gap-6">
              ...
              <div className="sm:w-1/2 relative flex">
                    ...
                    <div className="relative flex items-center justify-center rounded-lg overflow-hidden bg-base-300 h-full w-full aspect-[9/16]">
                      <img 
              ...
              <div className="sm:w-1/2">
                <h3 className="text-sm font-bold mb-2 capitalize">{selectedWallpaper.title}</h3>
                <div className="flex gap-2 items-center mb-4">
                  <p className="text-sm opacity-70">
                    {selectedWallpaper.category || 'Phone Wallpaper'}
                  </p>
                ...
                <div className="grid grid-cols-2 gap-2 mb-6">
                  <div className="stat bg-base-200 rounded-box p-3">
                    ...
                    <div className="stat-value text-xs">{(selectedWallpaper.downloads || 0).toLocaleString()}</div>
                  </div>                  <div className="stat bg-base-200 rounded-box p-3">
                    <div className="stat-title text-xs">Added</div>
                    <div className="stat-value text-xs font-mono">{formatDate(selectedWallpaper.$createdAt)}</div>
                  </div>
                </div>
                ...
                <div className="mt-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="badge">{selectedWallpaper.category || 'Phone'}</span>
...
export default PhoneWallpapers;